---
title: "Part 2, Importance of String Analysis in Reverse Engineering"
...
After starting the bomb executable, we're presented with four options - YELLOW, GREEN, BLUE and RED, corresponding to the wires that I need to cut to deactivate the bomb. When I choose an option I are asked about a password. Entering the right password cuts the wire and entering the wrong password blows the bomb. Our mission is to reverse the algorithms and find the passwords for each wire and deactivate the bomb.
...
<div style="text-align: center;">
  <img src="assets/bomb_yellow_1.png" style="border-radius: 10px;" alt="bomb_yellow_1.png">
</div>
...
<div style="text-align: center;">
  <img src="assets/bomb_yellow_2.png" style="border-radius: 10px;" alt="bomb_yellow_2.png">
</div>

It worked! I cut the yellow wire.
...
<div style="text-align: center;">
  <img src="assets/bomb_green_1.png" style="border-radius: 10px;" alt="bomb_green_1.png">
</div>
...
;SECTION CONT1 -> GO HERE AFTER 'L', 'R', '\n' SECTIONS
   ...
   ; the FIRST address (the one I started with) of the graph variable
   ;
...
;SECTION CONT2 -> GO HERE IF flag != 0
   ...
   ; tells if I reached the end of our input (reached newline) or 
   ; that I typed an invalid character
...
So I enter a path in the form 'LLRRLRLRLLR' and the values of each node with pass through and the expected result shuld be 0x40475194.

And below are screenshots from the IDA graph view (if it's hard to see open them in a new tab):

<div style="text-align: center;">
  <img src="assets/bomb_blue_1.png" style="border-radius: 10px;" alt="bomb_blue_1.png">
</div>

<div style="text-align: center;">
  <img src="assets/bomb_blue_2.png" style="border-radius: 10px;" alt="bomb_blue_2.png">
</div>

<div style="text-align: center;">
  <img src="assets/bomb_blue_3.png" style="border-radius: 10px;" alt="bomb_blue_3.png">
</div>

<div style="text-align: center;">
  <img src="assets/bomb_blue_4.png" style="border-radius: 10px;" alt="bomb_blue_4.png">
</div>
...
<div style="text-align: center;">
  <img src="assets/bomb_blue_5.png" style="border-radius: 10px;" alt="bomb_blue_5.png">
</div>
...
<div style="text-align: center;">
  <img src="assets/bomb_red_1.png" style="border-radius: 10px;" alt="bomb_red_1.png">
</div>
...
preflight:
<div style="text-align: center;">
  <img src="assets/bomb_red_2.png" style="border-radius: 10px;" alt="bomb_red_2.png">
</div>

red:
<div style="text-align: center;">
  <img src="assets/bomb_red_3.png" style="border-radius: 10px;" alt="bomb_blue_3.png">
</div>
...
<div style="text-align: center;">
  <img src="assets/bomb_red_4.png" style="border-radius: 10px;" alt="bomb_red_4.png">
</div>
